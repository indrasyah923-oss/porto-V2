...
import { Globe, Github, Mail, ExternalLink, Send, User, MessageSquare, CheckCircle, Home as HomeIcon, UserCircle, Award, Briefcase, Phone, BookOpen } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 relative overflow-x-hidden">
      ...
      <div className="relative z-10 pb-20 md:pb-0">
        ...
        <nav className="hidden md:block fixed top-0 w-full bg-gray-900/80 backdrop-blur-md border-b border-gray-800 z-50">
          <div className=" mx-auto px-20 py-5 flex justify-between items-center">
            ...
            <div className="flex items-center gap-8">
              {['home', 'about', 'skills', 'blog', 'projects', 'contact'].map(section => (
        ...
        <section id="home" ref={sectionRefs.home} className="md:min-h-screen flex items-center px-4 md:px-6 pt-36 md:pt-20 mb-4 md:mb-32">
      ...
      <section id="about" ref={sectionRefs.about} className={`md:min-h-screen flex items-center px-4 md:px-6 py-20 md:py-32 mb-4 md:mb-32 transition-all duration-1000 ${visibleSections.about ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
  <div className="md:px-14 px-0 w-full mx-auto">
    ...
    <div className="flex flex-col lg:flex-row gap-6 md:gap-20 items-start lg:items-center">
      ...
      <div className="w-full lg:w-[400px] flex-shrink-0 relative order-1">
        <div className="flex lg:block items-start gap-4 lg:gap-0">
          ...
          <div className="w-40 lg:w-full flex-shrink-0 relative">
      ...
      <div className="flex-grow space-y-4 md:space-y-8 order-2 w-full">
        ...
        <section id="blog" ref={sectionRefs.blog} className="min-h-screen px-4 md:px-6 py-20 md:py-32 mb-20 md:mb-32">
  <div className="md:px-14 px-0 w-full mx-auto">
    <div className="text-center mb-12 md:mb-16">
      <h2 className="text-3xl md:text-5xl font-bold mb-3 md:mb-4 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">{t.blog.title}</h2>
